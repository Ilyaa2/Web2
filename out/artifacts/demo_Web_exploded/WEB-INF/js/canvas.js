...
// старая функция отправки
// function sendRequest(x,y,r){
//     window.location.href = window.location.href+"table?btn="+x+"&text="+y+"&radiobutton="+r;
// }
